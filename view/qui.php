...
<head>
    ...
    <title>Qui sommes nous ? - Magestco </title>
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/img/favicon/favicon-32x32.png">
    <link rel="stylesheet" href="../assets/css/footer.css">
    <link rel="stylesheet" href="../assets/css/navigation.css">
    <link rel="stylesheet" href="../assets/css/qui.css">
</head>
...
<body>
    ...
    <section>
        <div class="container">
            ...
            <p>
                <strong>MAGESTCO</strong> est un service dédié aux professionnels de la maintenance, artisans, ou tous métiers avec tournées. Nous proposons également nos solutions aux entreprises ayant pour activité la gestion de logements, ou gestion commerciale en général.
                Nous nous inspirons de vos expériences, de vos problématiques pour développer des outils adaptés, intuitifs et collaboratifs. Notre but : vous libérer du temps et vous faciliter au quotidien la vie d’entreprise.
            </p>
            <ul>
                <h3>Pour aller plus loin dans l’accompagnement des professionnels, nous avons décidé de proposer et dispenser des formations, telles que :</h3>
            ...
            <ul>
                <h3>Et parce qu’une entreprise florissante est une entreprise qui prend soin de ses clients, nous avons également pensé à eux :</h3>
