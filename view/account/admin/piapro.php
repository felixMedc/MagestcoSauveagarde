				...
				<td style = "vertical-align: top; padding: 20px;">
					...
					<table color = "#000000" border = "0" style = "background-color: #EEEEEE; opacity: 0.9; -webkit-border-radius: 25px; -moz-border-radius: 25px; border-radius: 25px;">
							...
							<td style = "padding: 20px;">
								...
								$compteur = 0;
								$pagination = 0;
								$resultats=$bdd->query("SELECT RaisonSocialeProfessionnel, IDProfessionnel, IDPIA, LibPIA FROM professionnel, piapro, pialvl1 WHERE professionnel.IdentifiantProfessionnel = piapro.IDProfessionnel AND piapro.IDPIA = pialvl1.IdentifiantPIA AND IDSection = '1' AND IDQuestion = '1' ORDER BY RaisonSocialeProfessionnel;");
								...
								$resultats=$bdd->query("SELECT RaisonSocialeProfessionnel, IDProfessionnel, IDPIA, LibPIA FROM professionnel, piapro, pialvl1 WHERE professionnel.IdentifiantProfessionnel = piapro.IDProfessionnel AND piapro.IDPIA = pialvl1.IdentifiantPIA AND IDSection = '1' AND IDQuestion = '1' ORDER BY RaisonSocialeProfessionnel LIMIT $nbprec,$maxlignes;");
